...
async def _run_news_ingest() -> None:
    ...
    from backend.rag.ingestion import news as news_ingest
    from backend.rag.ingestion.collections import ensure_collections
...
async def _run_historical_update() -> None:
    from backend.rag.ingestion.universe import universe
    from backend.rag.ingestion import historical as hist_ingest
    from backend.rag.ingestion.collections import ensure_collections
