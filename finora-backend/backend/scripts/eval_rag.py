...
Usage:
    ...
    python scripts/eval_rag.py --tickers AAPL --output backend/data/eval_results/ragas_20260424.json
"""
...
def main() -> None:
    ...
    from backend.rag.evaluation.ragas_eval import TARGETS, run_ragas_eval
