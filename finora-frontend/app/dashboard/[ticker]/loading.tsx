            ...
            <div className="rounded-xl border border-border bg-card overflow-hidden animate-pulse">
              ...
              <div className="p-3 grid grid-cols-3 sm:grid-cols-5 gap-2">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="flex flex-col items-center gap-1.5 p-2.5 rounded-lg border border-border/40 bg-muted/10">
                    <div className="w-9 h-9 rounded-xl bg-muted" />
                    <div className="w-10 h-2.5 bg-muted rounded" />
                    <div className="w-14 h-2 bg-muted rounded hidden sm:block" />
                  </div>
                ))}
              </div>
            </div>
